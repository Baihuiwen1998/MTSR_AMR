...
public class VNSFCFS {
    CalFitness cf;
    CalFitness cfImpr;
    Instance instance;
    Operators operator;

    public VNSFCFS(Instance instance, CalFitness cf, CalFitness cfImpr){
        this.cf = cf;
        this.cfImpr = cfImpr;
    ...
    public Solution calVNS(Solution initialSolution) throws IOException, GRBException, CloneNotSupportedException {
        Solution bestSolution = initialSolution;
        int iter = 0;
        Solution shakedSolution, neighSolution, imprShakedSolution;
        int[] shakedOrderSeq;
        ...
        CFBasic cfBasic = new CFBasic();
        cfBasic.init(instance);
        bestSolution = cfBasic.cal(bestSolution);
